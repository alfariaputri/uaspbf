...
<head>
	<title>Login | RENTAL.IN MOBIL</title>
	<meta charset="utf-8">
				...
				<div class="auth-box ">
							...
							<form class="form-auth-small" action="/postlogin" method="POST">
								...
								<div class="form-group">
									...
									<input name="email" type="email" class="form-control" id="signin-email"
									 placeholder="Email: admin@gmail.com" value="admin@gmail.com">
								</div>
								<div class="form-group">
									<label for="signin-password" class="control-label sr-only">Password</label>
									<input name="password" type="password" class="form-control" id="signin-password"
									 placeholder="Password: ganesha" value="ganesha">
								</div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Website Penyewaan Mobil Terpercaya</h1>
							<p>by RENTAL.IN MOBIL</p>
						</div>
					</div>
